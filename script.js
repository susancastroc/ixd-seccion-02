...
var lorenIpsum = ["escuchar música","mirar la luna","sacar fotos","leer","ver series"];
...
function portada() {
    ...
    createElement('p','Me gusta '+random(lorenIpsum)+' en la portada.').parent(loPrincipal);
    select("a:nth-child(1)").style("font-weight", "bold").style("color", "#000000");
}

function pagina() {
    createSpan("Estás en page.html").parent("title");
    createElement('p','Me gusta '+random(lorenIpsum)+' en la página.').parent(loPrincipal);
